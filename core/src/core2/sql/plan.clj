...
(defn pit-less-than [pit1 pit2]
  (let [[pit-1 pit-2] (coerce-points-in-time pit1 pit2)]
    (neg? (.compareTo ^java.time.OffsetDateTime pit-1 ^java.time.OffsetDateTime pit-2))))

(defn pit-less-than-or-equal [pit1 pit2]
  (let [[pit-1 pit-2] (coerce-points-in-time pit1 pit2)
        res (.compareTo ^java.time.OffsetDateTime pit-1 ^java.time.OffsetDateTime pit-2)]
    (or (neg? res) (= res 0))))

(defn pit-greater-than [pit1 pit2]
  (let [[pit-1 pit-2] (coerce-points-in-time pit1 pit2)]
    (pos? (.compareTo ^java.time.OffsetDateTime pit-1 ^java.time.OffsetDateTime pit-2))))
