...
=== End scenarios:
* Core2 as a viable alternative to XTDB 1.x
  Spectrum:
  * A: Drop-in replacement for XTDB 1.x.
  * B: Essentially XTDB 1.x but with Arrow.
  * C: XTDB 1.x re-thought.
* Core2 canned, knowledge pulled into XTDB 1.x.

=== Things to consider:
* User migration?
* Maintaining XTDB 1.x.
...
* Stuck trying to replicateq XTDB 1.x.
...
* XTDB 1.x vs Core2 time/focus.
* Keeping the XTDB 1.x flame alive while we're working on Core2.
